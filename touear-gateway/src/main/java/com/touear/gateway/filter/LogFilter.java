...
import com.touear.gateway.AccessRecord;
...
public class LogFilter implements GlobalFilter, Ordered {
    ...
    private void writeAccessRecord(AccessRecord accessRecord) {
        ...
        log.info("\n\n start------------------------------------------------- \n " +
                        ...
                        "请求体:{}\n " +
                        "end------------------------------------------------- \n ",
                accessRecord.getPath(), accessRecord.getScheme(), accessRecord.getMethod(), accessRecord.getTargetUri(), accessRecord.getHeaders(), accessRecord.getRemoteAddress(), accessRecord.getFormData(), accessRecord.getBody());
    }
}
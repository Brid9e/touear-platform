package com.touear.core.auto.factories;
...
import com.touear.core.auto.common.AbstractBladeProcessor;
import com.touear.core.auto.common.MultiSetMap;
import com.touear.core.auto.service.AutoService;
...
public class AutoFactoriesProcessor extends AbstractBladeProcessor {
	 ...
	 * Feign 自动配置
	 */
	private static final String FEIGN_AUTO_CONFIGURE_KEY = "com.touear.feign.BerserkerFeignAutoConfiguration";
	/**

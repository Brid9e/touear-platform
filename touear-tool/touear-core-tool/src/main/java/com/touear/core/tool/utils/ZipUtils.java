...
public class ZipUtils {
	 ...
	 * 功能描述：压缩文件至制定文件
	 * 
	 * @param filename 目标文件路径【含文件名】
	 * @param outname  生成的压缩文件的路径【含文件名】
...
//		ZipUtils.toZip("E:\\开发\\交大场馆\\workspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\yypt-web\\upload\\dowload\\20190522152442_912签到表",
//				fos1, false);
//	}

 ...
 * @author L.cm
 */
public abstract class AbstractBladeBeanCopier {
	private static final Type CONVERTER = TypeUtils.parseType("org.springframework.cglib.core.Converter");
	private static final Type CLASS_UTIL = TypeUtils.parseType("com.touear.core.tool.utils");
	private static final Type BEAN_COPIER = TypeUtils.parseType(AbstractBladeBeanCopier.class.getName());
	...
	/**
	 * The map to store {@link AbstractBladeBeanCopier} of source type and class type for copy.
	 */
	private static final ConcurrentMap<BladeBeanCopierKey, AbstractBladeBeanCopier> BEAN_COPIER_MAP = new ConcurrentHashMap<>();

	public static AbstractBladeBeanCopier create(Class source, Class target, boolean useConverter) {
		return AbstractBladeBeanCopier.create(source, target, useConverter, false);
	}

	public static AbstractBladeBeanCopier create(Class source, Class target, boolean useConverter, boolean nonNull) {
	...
	public static class Generator extends AbstractClassGenerator {
		private static final Source SOURCE = new Source(AbstractBladeBeanCopier.class.getName());
		...
		@Override
		public AbstractBladeBeanCopier create(Object key) {
			return (AbstractBladeBeanCopier) super.create(key);
		}

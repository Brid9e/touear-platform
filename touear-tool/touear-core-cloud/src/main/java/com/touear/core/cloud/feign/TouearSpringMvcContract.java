 ...
 * 版本 处理
 *
 * @see com.touear.core.cloud.annotation.UrlVersion
 * @see com.touear.core.cloud.annotation.ApiVersion
 * @author L.cm
 */
public class TouearSpringMvcContract extends SpringMvcContract {

	public TouearSpringMvcContract(List<AnnotatedParameterProcessor> annotatedParameterProcessors, ConversionService conversionService) {

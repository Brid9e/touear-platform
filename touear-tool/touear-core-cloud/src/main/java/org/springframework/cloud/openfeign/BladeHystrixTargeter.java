...
import com.touear.core.cloud.feign.TouearFallbackFactory;

/**
 *  默认的 fallbackFactory L.cm 2019.01.19
 *
 * @author L.cm
 * @author Spencer Gibb
 * @author Erik Kringen
...
class TouearHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		//默认的 fallbackFactory
		TouearFallbackFactory bladeFallbackFactory = new TouearFallbackFactory(target);

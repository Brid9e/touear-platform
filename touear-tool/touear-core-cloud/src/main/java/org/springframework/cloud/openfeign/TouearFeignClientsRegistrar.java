...
import com.touear.core.cloud.feign.TouearFeignAutoConfiguration;
 ...
 */
@NoArgsConstructor
public class TouearFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	@Getter
	...
	private Class<?> getSpringFactoriesLoaderFactoryClass() {
		return TouearFeignAutoConfiguration.class;
	}

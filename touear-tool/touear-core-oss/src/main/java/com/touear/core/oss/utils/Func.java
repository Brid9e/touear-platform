...
import com.synjones.core.tool.jackson.JsonUtil;
import com.synjones.core.tool.snowflake.SnowFlake;
...
public class Func {
        ...
        try {
            ...
            for (Map.Entry<String, Object> stringObjectEntry : map.entrySet()) {
                ...
                if (field != null) {
                    ...
                    if(toStr(field.getType().getPackage()).indexOf("synjones") != -1) {
                        ...
                        if (genericType instanceof ParameterizedType) {
                            ...
                            if(toStr(actualTypeArgument.getPackage()).indexOf("synjones") != -1) {
	 ...
	 * @return {@link String}
	 * @author wangqq
	 * @date 2022-04-15 10:41:01
	 */
	public static String snowFlakeNextId(long workerId, long dataCenterId) {
		return SnowFlake.getInstance(workerId, dataCenterId).nextId();
	}
	/**
	 * 通过雪花算法，获取自增id
	 * @param workerId			工作ID (0~31)
	 ...
	 * @date 2022-04-15 10:41:01
	 */
	public static String snowFlakeNextId(long workerId) {
		return SnowFlake.getInstance(workerId, 0).nextId();
	}
	/**
	 * 通过雪花算法，获取自增id
	 * @return {@link String}

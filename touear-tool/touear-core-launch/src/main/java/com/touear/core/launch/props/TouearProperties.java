 ...
 * @author Chen
 */
@ConfigurationProperties("touear")
public class TouearProperties implements EnvironmentAware, EnvironmentCapable {
	@Nullable
	...
	public String getEnv() {
		...
		String env = environment.getProperty("touear.env");
		Assert.notNull(env, "请使用 TouearApplication 启动...");
		return env;
	}
	...
	public String getName() {
		Objects.requireNonNull(environment, "Spring boot 环境下 Environment 不可能为null");
		return environment.getProperty("spring.application.name", environment.getProperty("touear.name", ""));
	}
